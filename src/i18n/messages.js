...
export const messages = {
  [LOCALES.ENGLISH]: {
    ...
    mainInfo_content: "React-JS Specialist's personal website.",
    myWorks_header: "MY PROJECTS",
    aboutMe_Header: "ABOUT ME",
    aboutMe_Who: "WHO AM I",
    aboutMe_info:
      "I am a beginner front-end developer from St. Petersburg. I am 25 years old and the decision to connect my future career with Frontend development came to me two years ago.",
    aboutMe_content:
    ...
    aboutMe_vector:
      "Graduated from paid courses of spoken English (B2) in a private educational institution \n < School of Informatics and Applied Mathematics with in-depth study of English <VECTOR++> > (2016-2018)",
    aboutMe_tech_header: "I USE",
    aboutMe_tech:
      "I am ready to offer my employer more than two years of development experience in React/NextJS and knowledge of a large number of different libraries.",
    portFirst_header:
      "Platform for online purchase of tickets for music concerts \n < CONCERT CLUB >",
    portFirst_usages:
  ...
  [LOCALES.RUSSIAN]: {
    ...
    aboutMe_vector:
      "Окончил платные курсы разговорного английского языка (В2) в частном образовательном учреждении \n < Школа информатики и прикладной математики с углубленным изучением английского языка <ВЕКТОР++> > (2016-2018)",
    aboutMe_tech_header: "МОЙ СТЭК",
    aboutMe_tech:
      "Своему работодателю я готов предложить более двух лет опыта разработки на React/NextJS и знание большого количества различных библиотек.",
    portFirst_header:
      "Платформа для онлайн-покупки билетов музыкальных групп \n < CONCERT CLUB >",
    portFirst_usages:
    ...
    reviews_PolyaText:
      "Разрабатываю с Тимуром не первый сайт, работа всегда проходит очень чётко и грамотно. Отдельное спасибо за внимание к деталям, мне как дизайнеру, это очень важно. Все всегда сделано вовремя. Мои графические интерактивные идеи исполняются и воплощаются в жизнь. Спасибо Тимуру за работу, все великолепно.",
  },
};
